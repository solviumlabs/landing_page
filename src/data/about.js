// src/data/about.js — Datos de "Por qué nosotros" (SSOT)
...
export const ABOUT_SECTION = {
  ...
  stats: [
    ...
    { value: 'Sr.',  label: { es: 'Nivel de Ingeniería', en: 'Engineering Level' } },
    { value: 'ROI',  label: { es: 'Enfoque de Negocio', en: 'Business Focus' } }
  ]
};
